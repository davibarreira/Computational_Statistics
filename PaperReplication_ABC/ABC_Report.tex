...
Model choice is part of Bayesian analysis in which
different models are compared and the end goal is
to evaluate the probability a model generated the data
compared to others. 
In addition to the parameters
of each model, the inference also estimates
a parameter
$\mathcal{M}$ which corresponds to each specific
